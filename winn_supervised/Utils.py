...
def download_mnist(mnist_dir = './mnist'):
    if not os.path.exists(mnist_dir):
        ...
        urllib.request.urlretrieve('http://cseweb.ucsd.edu/~weijian/static/datasets/mnist/t10k-images-idx3-ubyte.gz', 
                           './mnist/t10k-images-idx3-ubyte.gz')
        urllib.request.urlretrieve('http://cseweb.ucsd.edu/~weijian/static/datasets/mnist/t10k-labels-idx1-ubyte.gz', 
                           './mnist/t10k-labels-idx1-ubyte.gz')
        urllib.request.urlretrieve('http://cseweb.ucsd.edu/~weijian/static/datasets/mnist/train-images-idx3-ubyte.gz', 
                           './mnist/train-images-idx3-ubyte.gz')
        urllib.request.urlretrieve('http://cseweb.ucsd.edu/~weijian/static/datasets/mnist/train-labels-idx1-ubyte.gz', 
